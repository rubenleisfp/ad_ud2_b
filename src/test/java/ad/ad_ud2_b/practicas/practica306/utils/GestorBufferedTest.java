...
public class GestorBufferedTest {
    ...
    public void testReadFileNoFileExists() throws IOException {
        ...
        List<String> result = ad.ad_ud2_b.practicas.practica306.utils.GestorBuffered.read(testFilePath);
    ...
    public void testWriteLinesAppendFalse() throws IOException {
        ...
        ad.ad_ud2_b.practicas.practica306.utils.GestorBuffered.writeLines(testFilePath, false, lines);
    ...
    public void testWriteLinesAppendTrue() throws IOException {
        ...
        ad.ad_ud2_b.practicas.practica306.utils.GestorBuffered.writeLines(testFilePath, false, lines1);
        // Ahora escribe con append
        ad.ad_ud2_b.practicas.practica306.utils.GestorBuffered.writeLines(testFilePath, true, lines2);
